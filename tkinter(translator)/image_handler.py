...
class ImageHandler:
    """It is the base class for managing images."""
    ...
    def load_image(self):
        """This function loads and resize the image. This is an abstract method."""
...
class BackgroundImage(ImageHandler):
    ...
    def load_image(self):
        """This function loads the background image and resize it."""
        try:
